...
const milestones = [
  {
    ...
    description: 'Moved to the French part of Switzerland.',
    highlight: 'Tiny me learning French and eating way too much chocolate.',
    icon: (
  ...
  },
  {
    ...
    highlight: 'That L turned into a W — became obsessed with how computers break.',
    icon: (
      <svg viewBox="0 0 24 24" fill="none" className="w-5 h-5">
  ...
  },
  {
    ...
    highlight: 'That little thing was fighting for its life running Kali Linux.',
    icon: (
      <svg viewBox="0 0 24 24" fill="none" className="w-5 h-5">
    ...
    color: '#22c55e' // green (Linux)
  },
  {
    year: '2014',
    age: '12',
    title: 'EPFL Euler Programme',
    description: 'Got into the Euler Mathematics Certification at EPFL.',
    highlight: 'Three years of advanced math & physics. Nerd arc unlocked.',
    icon: (
      <svg viewBox="0 0 24 24" fill="none" className="w-5 h-5">
    ...
    color: '#ef4444' // red (EPFL)
  },
  {
    year: '2017',
    age: '15',
    title: 'MNG Rämibühl',
    description: 'High school with focus on Applied Math & Physics.',
    highlight: 'Back to the German part. Zürich arc begins.',
    icon: (
      <svg viewBox="0 0 24 24" fill="none" className="w-5 h-5">
  ...
  },
  {
    ...
    age: '17',
    title: 'Peak Twilight',
    description: 'Launched my artist alias. Started producing lofi beats.',
    highlight: 'Music arc unlocked. No turning back now.',
    icon: (
      <svg viewBox="0 0 24 24" fill="none" className="w-5 h-5">
  ...
  },
  {
    ...
    highlight: 'One of the biggest & oldest table tennis clubs in Switzerland.',
    icon: (
      <svg viewBox="0 0 24 24" fill="none" className="w-5 h-5">
  ...
  },
  {
    ...
    description: 'Co-founded a lofi label with artists worldwide.',
    highlight: 'Built one of the first lofi label websites. 100+ artists deep.',
    hasLiveCounter: true,
    icon: (
      <svg viewBox="0 0 24 24" fill="none" className="w-5 h-5">
    ...
    color: '#f97316' // orange (Soothe brand)
  },
  {
    year: '2021',
    age: '19',
    title: 'ETH Zürich',
    description: 'Started BSc Computer Science at ETH.',
    highlight: 'Running labels and freelancing on the side. Sleep is overrated.',
    icon: (
      <svg viewBox="0 0 24 24" fill="none" className="w-5 h-5">
        <path d="M4.26 10.147a60.438 60.438 0 0 0-.491 6.347A48.62 48.62 0 0 1 12 20.904a48.62 48.62 0 0 1 8.232-4.41 60.46 60.46 0 0 0-.491-6.347m-15.482 0a50.636 50.636 0 0 0-2.658-.813A59.906 59.906 0 0 1 12 3.493a59.903 59.903 0 0 1 10.399 5.84c-.896.248-1.783.52-2.658.814m-15.482 0A50.717 50.717 0 0 1 12 13.489a50.702 50.702 0 0 1 7.74-3.342M6.75 15a.75.75 0 1 0 0-1.5.75.75 0 0 0 0 1.5Zm0 0v-3.675A55.378 55.378 0 0 1 12 8.443m-7.007 11.55A5.981 5.981 0 0 0 6.75 15.75v-1.5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
      </svg>
    ),
    color: '#1e3a5f' // ETH dark blue
  },
  {
    year: '2022',
    age: '20',
    title: 'Soothe Studios',
    description: 'Co-founded the first in-house studio for a lofi label.',
    highlight: 'Mixed and mastered 150+ tracks. Ears are still recovering.',
    icon: (
      <svg viewBox="0 0 24 24" fill="none" className="w-5 h-5">
  ...
  },
  {
    ...
    age: '21',
    title: 'ASVZ Trainer',
    description: 'Became trainer at ASVZ — university sports for UZH & ETH.',
  ...
  },
  {
    ...
    age: '22',
    title: 'New Chapter',
    description: 'ETH → FHNW. Joined Migros as Cyber Defense Engineer.',
  ...
  },
  {
    ...
    description: 'Security by day. Apps, AI tools & beats by night.',
    highlight: 'Still adding side quests. The grind never stops fr.',
    icon: (
      <svg viewBox="0 0 24 24" fill="none" className="w-5 h-5">
