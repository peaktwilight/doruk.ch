    ...
    <footer className="py-16 border-t border-white/5">
      <div className="container mx-auto px-6">
        <div className="flex flex-col md:flex-row items-center justify-between gap-8">
          ...
          >
            <h3 className="text-2xl font-serif text-white mb-2">Doruk Tan Öztürk</h3>
        ...
        {/* Bottom */}
        <div className="mt-12 pt-8 border-t border-white/5 flex flex-col md:flex-row items-center justify-between gap-4 text-sm text-neutral-600">
          <p>© {new Date().getFullYear()} Doruk Tan Öztürk. All rights reserved.</p>
          <p>
            Crafted in Zürich
          </p>
        </div>
