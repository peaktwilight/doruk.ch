    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-6 text-center">
        ...
        >
          <a
            href="#projects"
            className="group inline-flex items-center gap-2 rounded-xl bg-amber-500 px-5 py-2.5 text-sm font-medium text-neutral-900 transition-all hover:bg-amber-400"
          >
            View Projects
          ...
          <a
            ...
            className="inline-flex items-center gap-2 rounded-xl border border-white/10 px-5 py-2.5 text-sm text-neutral-400 transition-all hover:border-white/20 hover:text-white"
          >
