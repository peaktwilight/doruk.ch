    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-6 text-center">
        ...
        >
          <div className="relative w-32 h-32 md:w-40 md:h-40 mx-auto">
            ...
            <div className="relative w-full h-full rounded-full overflow-hidden ring-1 ring-white/10">
              <img
                src="/assets/images/Doruk_Pro_Pic_On_Black_Closeup.png"
                alt="Doruk Tan Öztürk"
                className="w-full h-full object-cover"
              />
            </div>

            {/* Language flags - replacing Available badge */}
            <div className="absolute -bottom-2 left-1/2 -translate-x-1/2 flex -space-x-1.5">
              {languages.map((lang, i) => (
                <div
                  key={lang.code}
                  className="w-6 h-6 rounded-full border-2 border-neutral-900 overflow-hidden bg-neutral-800"
        ...
        >
          <a
            href="#projects"
            className="group inline-flex items-center gap-2 rounded-full bg-white px-5 py-2.5 text-sm font-medium text-neutral-900 transition-all hover:bg-amber-50"
          >
            View Projects
          ...
          <a
            ...
            className="inline-flex items-center gap-2 rounded-full border border-white/10 px-5 py-2.5 text-sm text-neutral-400 transition-all hover:bg-white/5 hover:text-white"
          >
